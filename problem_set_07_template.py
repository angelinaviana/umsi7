...
#         data = []
#         reader = csv.?(file_obj, delimiter=delimiter)
#     pass


# def write_dicts_to_csv(filepath, data, fieldnames, encoding=?, newline=?): #could have missing parameters
#     """
...
#     with open(filepath, 'w', encoding=? newline=?) as file_obj:
#         writer = csv.?(file_obj, fieldnames=fieldnames)
#         pass
